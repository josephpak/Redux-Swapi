...
- [x] Notice the file structure. There are certainly many ways by which one could layout an application.
- [x] This pattern is commonly used:
...
- The purpose of this mini-project is to expose you to the world of asynchronous Redux.
- [x] **Notice** the `package.json`. We have included a few new packages here for you.

  - [x] `redux-thunk redux-logger and axios`.
